...
?>
            <ul class="nav nav-tabs">
                <li id="basic_tab" class="active">
                    <a href="#basic-settings" data-toggle="tab">
                ...
                <li id="layout_tab">
                    <a href="#layout-settings" data-toggle="tab">
                        <?php echo JText::_('LAYOUT_SETTINGS'); ?>
                    </a>
                </li>
            </ul>
                ...
                <div id="basic-settings" class="tab-pane active tab-content">
                    <div class="row-fluid">
                        <div class="span6">
                            <fieldset class="adminform form-horizontal">
                                <legend>
                                    <?php echo JText::_( 'EDITOR_APPEARANCE' ); ?>
                                </legend>
                    ...
                    echo "<div  style=\"text-align: center; padding: 5px; \">".JText::_('NO_PARAMETERS')."</div>";
                        ...
                        <div class="span6">
                            <fieldset class="adminform form-horizontal">
                                <legend>
                                    <?php echo JText::_( 'LANGUAGE_SETTINGS' ); ?>
                                </legend>
                ...
                <div id="advanced-settings" class="tab-pane">
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            <fieldset class="adminform form-horizontal">
                                <legend>
                                    <?php echo JText::_( 'SOURCE_FORMATTING' ); ?>
                                </legend>
                  ...
                  echo "<div  style=\"text-align: center; padding: 5px; \">".JText::_('NO_PARAMETERS')."</div>";
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <fieldset class="adminform form-horizontal">
                                <legend>
                                    <?php echo JText::_( 'CUSTOM_CONFIGURATION' ); ?>
                                </legend>
                                <p>
                                    <?php echo JText::_( 'CUSTOM_CONFIGURATION_DESCRIPTION' ); ?>
                                </p>
                                <p>
                                    <?php echo str_replace("!conf", "<pre>CKEDITOR.config.entities = false;\nCKEDITOR.config.forcePasteAsPlainText = true;</pre>", JText::_( 'SAMPLE_CONFIGURATION' ).'!conf'); ?></p>
                                <?php if ($this->form->getFieldset('formatting')):?>
            ...
            echo strtr(
              JText :: _('LAYOUT_EDIT'),
                array(
                  ...
                  '!default' => '<a href="'.$link1.'">' . JText :: _('DEFAULT') .'</a>'
                    ...
                    <fieldset>
                        <legend>
                            <?php echo ucfirst($this->toolbar)?> Toolbar</legend>
              ...
              $many =  count($this->usedToolbars);
                ...
                ?>
                    ...
                    <fieldset>
                        <legend>
                            <?php echo JText::_( 'AVAILABLE_BUTTONS' ); ?>
                        </legend>
